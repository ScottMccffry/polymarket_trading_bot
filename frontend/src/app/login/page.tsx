      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary/20 via-primary/10 to-background relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-20">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              <h1 className="text-2xl font-bold">Doudinski</h1>
          ...
          <p className="text-lg text-muted-foreground mb-12">
            Harness the power of algorithmic trading to capitalize on prediction
            market opportunities with precision and speed.
          </p>
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Advanced algorithms detect market opportunities as they emerge
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold mb-1">Strategy Automation</h3>
                <p className="text-sm text-muted-foreground">
                  Configure take-profit, stop-loss, and trailing stops automatically
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold mb-1">Paper Trading Mode</h3>
                <p className="text-sm text-muted-foreground">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="flex items-center justify-center gap-3 mb-8 lg:hidden">
            ...
            <div>
              <h1 className="text-xl font-bold">Doudinski</h1>
            </div>
          </div>
